...
def fetch_cftc():
    ...
    Il file NON ha header — parse per indice colonna (documentazione CFTC ufficiale):
      col 0  = Market_and_Exchange_Names
      col 1  = As_of_Date_In_Form_YYMMDD
      col 3  = CFTC_Contract_Market_Code
      col 12 = Asset_Mgr_Positions_Long_All
      col 13 = Asset_Mgr_Positions_Short_All
      col 15 = Lev_Money_Positions_Long_All
      col 16 = Lev_Money_Positions_Short_All

    Salva con la DATA INTERNA del report (martedì), non con la data di oggi.
    """
    ...
    try:
        ...
        for cols in reader:
            ...
            # Data interna del report (col 1 = YYMMDD)
